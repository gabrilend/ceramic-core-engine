...
printf 'station a ('${DIR}/src/boxes/029-demo-boxes.c:triple_sum)\n  out 0 - 0$\n  in 0 = {\n      1.5,\n      2.5,\n      3.5\n  }\n' \
    > "${WORK}/multi.map"
...
printf 'station a ('${DIR}/src/boxes/029-demo-boxes.c:read_int_file)\n  out 0 - 0$\n  in 0 = fire\n' > "${WORK}/bare.map"
...
printf 'station a ('${DIR}/src/boxes/029-demo-boxes.c:read_int_file)\n  in 0 - 0$\nstation b ('${DIR}/src/boxes/029-demo-boxes.c:keep)\n  out 0 - 0$\n' \
    > "${WORK}/argument.map"
