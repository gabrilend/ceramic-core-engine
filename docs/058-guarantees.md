...
| S2 | A wire is an index, never a pointer. A wire written down today is valid forever. | Stations can never be removed or reordered, only added to a table that has room. | structure |
