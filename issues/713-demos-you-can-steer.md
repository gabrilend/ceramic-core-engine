...
| Page → engine | Every lever: add a station, configure a port, draw or cut a wire, convert a port's source | The construction surface ([212](212-one-way-to-build-a-program.md)), which is legal at any moment by design |
